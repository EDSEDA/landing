            ...
            <section className='section appearance'>
              <div>
                ...
                <p className='appearance_text'>
                  Перед клиентом на кассе будут выводиться персональные рекомендации, которые будут динамично изменяться в соответствии с его новыми товарами покупки.<br/><br/>
